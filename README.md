...
CloudMart is a production-style e-commerce platform built as a cloud and DevOps engineering flagship project. It combines a React frontend, Node.js microservices, PostgreSQL, Redis, Docker, Kubernetes, AWS, Terraform, GitHub Actions, Argo CD, Prometheus, Grafana, Alertmanager, SNS/SQS, and CloudWatch Logs.
...
CloudMart supports a functional e-commerce workflow:
...
- Helm chart for CloudMart application deployment.
...
│   ├── helm/cloudmart/               # CloudMart Helm chart
...
Argo CD watches the CloudMart Helm chart:

```text
infra/helm/cloudmart
```
...
Argo CD applies Helm chart to EKS
  |
  v
CloudMart pods roll out with new images
```

## Monitoring & Observability

CloudMart includes metrics, dashboards, alerts, and logs.
...
- [Prometheus/Grafana monitoring](docs/monitoring/cloudmart-monitoring.md)
...
![CloudMart website through ALB](docs/aws/screenshots/CloudMart%20website%20running%20through%20ALB.png)
...
![CloudMart in Argo CD](docs/aws/screenshots/CloudMart%20Application%20in%20Argo%20CD.png)

### Grafana Observability Dashboard

![Grafana CloudMart Observability dashboard](docs/aws/screenshots/Grafana%20CloudMart%20Observability%20dashboard.png)

### Prometheus Targets

![Prometheus targets showing CloudMart services UP](docs/aws/screenshots/Prometheus%20targets%20showing%20CloudMart%20services%20UP.png)
...
![CloudWatch log streams](docs/aws/screenshots/%20CloudWatch%20log%20streams%20showing%20CloudMart%20pods.png)
...
CloudMart is complete as a cloud-native DevOps portfolio project.
