# CloudMart AWS Cost Cleanup

Use this guide when you want to stop CloudMart AWS resources and reduce cost after working.
...
CloudMart currently keeps ECR images, GitHub code, and documentation. Those are useful to keep and are much cheaper than running EKS/RDS/Redis.
...
Wait until the CloudMart ALB disappears.
...
```text
eksctl-cloudmart-eks-cluster-addon-iamserviceaccount-...
```
