...
export TF_STATE_BUCKET=cloudmart-terraform-state-$AWS_ACCOUNT_ID
export TF_LOCK_TABLE=cloudmart-terraform-locks
```
Check:
```
...
Backend:
- S3 bucket: cloudmart-terraform-state-506098131053
- State key: dev/terraform.tfstate
- DynamoDB table: cloudmart-terraform-locks
- Region: us-east-1
